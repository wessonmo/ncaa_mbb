...
def parse_team_index(engine, data_type, schema_name, file_name, soup):
...
def parse_facility(engine, data_type, schema_name, file_name, soup):
...
def parse_coach(engine, data_type, schema_name, file_name, soup):
    season_id, school_id = int(file_name[:-5].split('_')[-2]), int(file_name[:-5].split('_')[-1])
...
def parse_schedule(engine, data_type, schema_name, file_name, soup):
    season_id, school_id = int(file_name[:-5].split('_')[-2]), int(file_name[:-5].split('_')[-1])
...
def parse_roster(engine, data_type, schema_name, file_name, soup):
    season_id, school_id = int(file_name[:-5].split('_')[-2]), int(file_name[:-5].split('_')[-1])
...
def parse_summary(engine, data_type, schema_name, file_name, soup):
...
def parse_box_score(engine, data_type, schema_name, file_name, soup):
...
def parse_game_time(engine, data_type, schema_name, file_name, soup):
    game_id = int(file_name[:-5])
...
def parse_game_location(engine, data_type, schema_name, file_name, soup):
    game_id = int(file_name[:-5])
...
def parse_officials(engine, data_type, schema_name, file_name, soup):
    game_id = int(file_name[:-5])
...
def parse_pbp(engine, data_type, schema_name, file_name, soup):
    game_id = int(file_name[:-5])
